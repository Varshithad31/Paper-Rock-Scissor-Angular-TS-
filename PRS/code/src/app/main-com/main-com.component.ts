...
export class MainComComponent {
  ...
  pap_win(){
    ...
    this.l_img_url="assets/image1/L_paper.jpg";
    this.r_img_url="assets/image1/R_rock.jpg";
  ...
  pap_draw(){
    ...
    this.l_img_url="assets/image1/L_paper.jpg";
    this.r_img_url="assets/image1/R_paper.jpg";
  ...
  pap_loss(){
    ...
    this.l_img_url="assets/image1/L_paper.jpg";
    this.r_img_url="assets/image1/R_scissor.jpg";
  ...
  rock_win(){
    ...
    this.h_win=this.h_win+2;
    this.m_lost=this.m_lost+1;
    this.l_img_url="assets/image1/L_rock.jpg";
    this.r_img_url="assets/image1/R_scissor.jpg";
  }
  ...
  sci_win(){
    ...
    this.h_win=this.h_win+2;
    this.m_lost=this.m_lost+1;
    this.l_img_url="assets/image1/L_scissor.jpg";
    this.r_img_url="assets/image1/R_paper.jpg";
...
l_img_url:string="assets/image1/L_paper.jpg";
r_img_url:string="assets/image1/R_paper.jpg";
